...
func (rt *_router) Handler() http.Handler {
	...
	rt.router.DELETE("/userActions/:UserId/interactions/postInteractions/:PhotoId/managerLikes/:likeId", rt.wrap(rt.unLikePost))

	rt.router.GET("/userActions/:UserId/interactions/postInteractions/managerLikes/:photoId", rt.wrap(rt.getLikePost))
